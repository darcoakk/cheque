...
{
    /// <summary>
    /// KKBDevirAlanBeanResponse
    /// </summary>
    [DataContract(Name = "KKBDevirAlanBeanResponse")]
    public partial class KKBDevirAlanBeanResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KKBDevirAlanBeanResponse" /> class.
        /// </summary>
        ...
        public KKBDevirAlanBeanResponse(string vergiNo = default(string), string vergiDairesi = default(string), string vergiDairesiIli = default(string), string sicilNo = default(string), int tescilMerkezi = default(int), int tescilIli = default(int), string unvan = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KKBDevirAlanBeanResponse {\n");
