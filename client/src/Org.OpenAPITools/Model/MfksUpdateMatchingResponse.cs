...
{
    /// <summary>
    /// MfksUpdateMatchingResponse
    /// </summary>
    [DataContract(Name = "MfksUpdateMatchingResponse")]
    public partial class MfksUpdateMatchingResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MfksUpdateMatchingResponse" /> class.
        /// </summary>
        ...
        public MfksUpdateMatchingResponse(string islemSonucu = default(string), string islemSonucuAciklama = default(string), string islemReferansNo = default(string), List<MfksUyariHataParametreEsleme> uyariHataListe = default(List<MfksUyariHataParametreEsleme>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfksUpdateMatchingResponse {\n");
