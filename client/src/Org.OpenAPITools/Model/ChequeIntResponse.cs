...
namespace Org.OpenAPITools.Model
{
    ...
    /// ChequeIntResponse
    /// </summary>
    [DataContract(Name = "ChequeIntResponse")]
    public partial class ChequeIntResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChequeIntResponse" /> class.
        /// </summary>
        /// <param name="errors">errors.</param>
        /// <param name="automaticallyResult">automaticallyResult.</param>
        public ChequeIntResponse(IslemResponse errors = default(IslemResponse), string automaticallyResult = default(string))
        {
            this.Errors = errors;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChequeIntResponse {\n");
