...
{
    /// <summary>
    /// MfksSiparisFormuBean
    /// </summary>
    [DataContract(Name = "MfksSiparisFormuBean")]
    public partial class MfksSiparisFormuBean : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MfksSiparisFormuBean" /> class.
        /// </summary>
        /// <param name="odemeYontemi">odemeYontemi.</param>
        ...
        public MfksSiparisFormuBean(string odemeYontemi = default(string), string teslimTarihi = default(string), string muhtemelFaturaKesimTarihi = default(string), string tahsilatBeklentiTarihi = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets OdemeYontemi
        /// </summary>
        [DataMember(Name = "odemeYontemi", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfksSiparisFormuBean {\n");
            sb.Append("  OdemeYontemi: ").Append(OdemeYontemi).Append("\n");
