...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IhaleYasaklilikInfoRequest")]
    public partial class IhaleYasaklilikInfoRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IhaleYasaklilikInfoRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IhaleYasaklilikInfoRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IhaleYasaklilikInfoRequest" /> class.
        /// </summary>
        ...
        public IhaleYasaklilikInfoRequest(string uygulama = default(string), string olayNo = default(string), string userName = default(string), string tCKNVKN = default(string))
        {
            // to ensure "uygulama" is required (not null)
            if (uygulama == null)
            {
                throw new ArgumentNullException("uygulama is a required property for IhaleYasaklilikInfoRequest and cannot be null");
            }
            this.Uygulama = uygulama;
            // to ensure "olayNo" is required (not null)
            if (olayNo == null)
            {
                throw new ArgumentNullException("olayNo is a required property for IhaleYasaklilikInfoRequest and cannot be null");
            }
            this.OlayNo = olayNo;
            // to ensure "userName" is required (not null)
            if (userName == null)
            {
                throw new ArgumentNullException("userName is a required property for IhaleYasaklilikInfoRequest and cannot be null");
            }
            this.UserName = userName;
            // to ensure "tCKNVKN" is required (not null)
            if (tCKNVKN == null)
            {
                throw new ArgumentNullException("tCKNVKN is a required property for IhaleYasaklilikInfoRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IhaleYasaklilikInfoRequest {\n");
