...
{
    /// <summary>
    /// CorporateKKBRelationRequest
    /// </summary>
    [DataContract(Name = "CorporateKKBRelationRequest")]
    public partial class CorporateKKBRelationRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CorporateKKBRelationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CorporateKKBRelationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CorporateKKBRelationRequest" /> class.
        /// </summary>
        ...
        /// <param name="soncirantalist">soncirantalist.</param>
        public CorporateKKBRelationRequest(string uygulama = default(string), string olayNo = default(string), string userName = default(string), string tCKNVKN = default(string), string unvan = default(string), string musteriNo = default(string), List<SonCirantaList> soncirantalist = default(List<SonCirantaList>))
        {
            // to ensure "uygulama" is required (not null)
            if (uygulama == null)
            {
                throw new ArgumentNullException("uygulama is a required property for CorporateKKBRelationRequest and cannot be null");
            }
            this.Uygulama = uygulama;
            // to ensure "olayNo" is required (not null)
            if (olayNo == null)
            {
                throw new ArgumentNullException("olayNo is a required property for CorporateKKBRelationRequest and cannot be null");
            }
            this.OlayNo = olayNo;
            // to ensure "userName" is required (not null)
            if (userName == null)
            {
                throw new ArgumentNullException("userName is a required property for CorporateKKBRelationRequest and cannot be null");
            }
            this.UserName = userName;
            // to ensure "tCKNVKN" is required (not null)
            if (tCKNVKN == null)
            {
                throw new ArgumentNullException("tCKNVKN is a required property for CorporateKKBRelationRequest and cannot be null");
            }
            this.TCKNVKN = tCKNVKN;
            this.Unvan = unvan;
            this.MusteriNo = musteriNo;
            this.Soncirantalist = soncirantalist;
        }
        ...
        /// <summary>
        /// Gets or Sets Soncirantalist
        /// </summary>
        [DataMember(Name = "soncirantalist", EmitDefaultValue = true)]
        public List<SonCirantaList> Soncirantalist { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CorporateKKBRelationRequest {\n");
            ...
            sb.Append("  Soncirantalist: ").Append(Soncirantalist).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
