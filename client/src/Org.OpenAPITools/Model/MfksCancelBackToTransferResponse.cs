...
{
    /// <summary>
    /// MfksCancelBackToTransferResponse
    /// </summary>
    [DataContract(Name = "MfksCancelBackToTransferResponse")]
    public partial class MfksCancelBackToTransferResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MfksCancelBackToTransferResponse" /> class.
        /// </summary>
        ...
        public MfksCancelBackToTransferResponse(string islemSonucu = default(string), string islemSonucuAciklama = default(string), string islemReferansNo = default(string), List<MfksUyariHataListeDevGunc> uyariHataListe = default(List<MfksUyariHataListeDevGunc>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfksCancelBackToTransferResponse {\n");
