...
{
    /// <summary>
    /// KKBCommercialRegistryAnnouncementDetailResponse
    /// </summary>
    [DataContract(Name = "KKBCommercialRegistryAnnouncementDetailResponse")]
    public partial class KKBCommercialRegistryAnnouncementDetailResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KKBCommercialRegistryAnnouncementDetailResponse" /> class.
        /// </summary>
        /// <param name="hataKodu">hataKodu.</param>
        /// <param name="hataAciklama">hataAciklama.</param>
        /// <param name="ilanBean">ilanBean.</param>
        public KKBCommercialRegistryAnnouncementDetailResponse(string hataKodu = default(string), string hataAciklama = default(string), List<KKBIlanBeanResponse> ilanBean = default(List<KKBIlanBeanResponse>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KKBCommercialRegistryAnnouncementDetailResponse {\n");
