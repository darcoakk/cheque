...
{
    /// <summary>
    /// MfksRollbackToTransferListResponse
    /// </summary>
    [DataContract(Name = "MfksRollbackToTransferListResponse")]
    public partial class MfksRollbackToTransferListResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MfksRollbackToTransferListResponse" /> class.
        /// </summary>
        ...
        /// <param name="geriDevirKaydi">geriDevirKaydi.</param>
        public MfksRollbackToTransferListResponse(string islemSonucu = default(string), string islemSonucuAciklama = default(string), string islemReferansNo = default(string), List<MfksUyariHataListeDevGunc> uyariHataListe = default(List<MfksUyariHataListeDevGunc>), List<MfksGeriDevirKaydi> geriDevirKaydi = default(List<MfksGeriDevirKaydi>))
        {
            ...
            this.GeriDevirKaydi = geriDevirKaydi;
        }
        ...
        /// <summary>
        /// Gets or Sets GeriDevirKaydi
        /// </summary>
        [DataMember(Name = "geriDevirKaydi", EmitDefaultValue = true)]
        public List<MfksGeriDevirKaydi> GeriDevirKaydi { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfksRollbackToTransferListResponse {\n");
            ...
            sb.Append("  GeriDevirKaydi: ").Append(GeriDevirKaydi).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
