...
{
    /// <summary>
    /// MfksAddBackToTransferResponse
    /// </summary>
    [DataContract(Name = "MfksAddBackToTransferResponse")]
    public partial class MfksAddBackToTransferResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MfksAddBackToTransferResponse" /> class.
        /// </summary>
        ...
        public MfksAddBackToTransferResponse(string islemSonucu = default(string), string islemSonucuAciklama = default(string), string islemReferansNo = default(string), List<MfksUyariHataListeDevGunc> uyariHataListe = default(List<MfksUyariHataListeDevGunc>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfksAddBackToTransferResponse {\n");
