...
{
    /// <summary>
    /// MfksTransferCancellationResponse
    /// </summary>
    [DataContract(Name = "MfksTransferCancellationResponse")]
    public partial class MfksTransferCancellationResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MfksTransferCancellationResponse" /> class.
        /// </summary>
        ...
        public MfksTransferCancellationResponse(string islemSonucu = default(string), string islemSonucuAciklama = default(string), string islemReferansNo = default(string), List<MfksUyariHataListeDevGunc> uyariHataListe = default(List<MfksUyariHataListeDevGunc>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfksTransferCancellationResponse {\n");
