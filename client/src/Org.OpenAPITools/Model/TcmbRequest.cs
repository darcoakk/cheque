...
namespace Org.OpenAPITools.Model
{
    ...
    /// TcmbRequest
    /// </summary>
    [DataContract(Name = "TcmbRequest")]
    public partial class TcmbRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TcmbRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TcmbRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TcmbRequest" /> class.
        /// </summary>
        ...
        public TcmbRequest(string uygulama = default(string), string olayNo = default(string), string userName = default(string), string tCKNVKN = default(string), string unvan = default(string), string ilKodu = default(string))
        {
            // to ensure "uygulama" is required (not null)
            if (uygulama == null)
            {
                throw new ArgumentNullException("uygulama is a required property for TcmbRequest and cannot be null");
            }
            this.Uygulama = uygulama;
            // to ensure "olayNo" is required (not null)
            if (olayNo == null)
            {
                throw new ArgumentNullException("olayNo is a required property for TcmbRequest and cannot be null");
            }
            this.OlayNo = olayNo;
            // to ensure "userName" is required (not null)
            if (userName == null)
            {
                throw new ArgumentNullException("userName is a required property for TcmbRequest and cannot be null");
            }
            this.UserName = userName;
            // to ensure "tCKNVKN" is required (not null)
            if (tCKNVKN == null)
            {
                throw new ArgumentNullException("tCKNVKN is a required property for TcmbRequest and cannot be null");
            }
