...
{
    /// <summary>
    /// MfksUpdateCollectionStatusResponse
    /// </summary>
    [DataContract(Name = "MfksUpdateCollectionStatusResponse")]
    public partial class MfksUpdateCollectionStatusResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MfksUpdateCollectionStatusResponse" /> class.
        /// </summary>
        ...
        public MfksUpdateCollectionStatusResponse(string islemSonucu = default(string), string islemSonucuAciklama = default(string), string islemReferansNo = default(string), List<MfksUyariHataListeDevGunc> uyariHataListe = default(List<MfksUyariHataListeDevGunc>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfksUpdateCollectionStatusResponse {\n");
