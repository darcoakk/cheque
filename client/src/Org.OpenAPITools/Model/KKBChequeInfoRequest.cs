...
{
    /// <summary>
    /// KKBChequeInfoRequest
    /// </summary>
    [DataContract(Name = "KKBChequeInfoRequest")]
    public partial class KKBChequeInfoRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KKBChequeInfoRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KKBChequeInfoRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KKBChequeInfoRequest" /> class.
        /// </summary>
        ...
        /// <param name="cekList">cekList.</param>
        public KKBChequeInfoRequest(string uygulama = default(string), string olayNo = default(string), string userName = default(string), string tCKNVKN = default(string), string musteriNo = default(string), List<CekList> cekList = default(List<CekList>))
        {
            // to ensure "uygulama" is required (not null)
            if (uygulama == null)
            {
                throw new ArgumentNullException("uygulama is a required property for KKBChequeInfoRequest and cannot be null");
            }
            this.Uygulama = uygulama;
            // to ensure "olayNo" is required (not null)
            if (olayNo == null)
            {
                throw new ArgumentNullException("olayNo is a required property for KKBChequeInfoRequest and cannot be null");
            }
            this.OlayNo = olayNo;
            // to ensure "userName" is required (not null)
            if (userName == null)
            {
                throw new ArgumentNullException("userName is a required property for KKBChequeInfoRequest and cannot be null");
            }
            this.UserName = userName;
            // to ensure "tCKNVKN" is required (not null)
            if (tCKNVKN == null)
            {
                throw new ArgumentNullException("tCKNVKN is a required property for KKBChequeInfoRequest and cannot be null");
            }
        ...
        /// <summary>
        /// Gets or Sets CekList
        /// </summary>
        [DataMember(Name = "cekList", EmitDefaultValue = true)]
        public List<CekList> CekList { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KKBChequeInfoRequest {\n");
            ...
            sb.Append("  CekList: ").Append(CekList).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
