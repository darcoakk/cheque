...
{
    /// <summary>
    /// MfksUyariHataListeDevGunc
    /// </summary>
    [DataContract(Name = "MfksUyariHataListeDevGunc")]
    public partial class MfksUyariHataListeDevGunc : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MfksUyariHataListeDevGunc" /> class.
        /// </summary>
        /// <param name="uyariHataKod">uyariHataKod.</param>
        /// <param name="uyariHataKodAciklama">uyariHataKodAciklama.</param>
        public MfksUyariHataListeDevGunc(string uyariHataKod = default(string), string uyariHataKodAciklama = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfksUyariHataListeDevGunc {\n");
