...
{
    /// <summary>
    /// KKBCrossChequeInfoRequest
    /// </summary>
    [DataContract(Name = "KKBCrossChequeInfoRequest")]
    public partial class KKBCrossChequeInfoRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KKBCrossChequeInfoRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KKBCrossChequeInfoRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KKBCrossChequeInfoRequest" /> class.
        /// </summary>
        ...
        public KKBCrossChequeInfoRequest(string uygulama = default(string), string olayNo = default(string), string userName = default(string), string tCKNVKN = default(string), string sonCirantaTCKNVKN = default(string))
        {
            // to ensure "uygulama" is required (not null)
            if (uygulama == null)
            {
                throw new ArgumentNullException("uygulama is a required property for KKBCrossChequeInfoRequest and cannot be null");
            }
            this.Uygulama = uygulama;
            // to ensure "olayNo" is required (not null)
            if (olayNo == null)
            {
                throw new ArgumentNullException("olayNo is a required property for KKBCrossChequeInfoRequest and cannot be null");
            }
            this.OlayNo = olayNo;
            // to ensure "userName" is required (not null)
            if (userName == null)
            {
                throw new ArgumentNullException("userName is a required property for KKBCrossChequeInfoRequest and cannot be null");
            }
            this.UserName = userName;
            // to ensure "tCKNVKN" is required (not null)
            if (tCKNVKN == null)
            {
                throw new ArgumentNullException("tCKNVKN is a required property for KKBCrossChequeInfoRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KKBCrossChequeInfoRequest {\n");
