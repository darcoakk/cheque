...
{
    /// <summary>
    /// MfksAddToTransferRequest
    /// </summary>
    [DataContract(Name = "MfksAddToTransferRequest")]
    public partial class MfksAddToTransferRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MfksAddToTransferRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MfksAddToTransferRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MfksAddToTransferRequest" /> class.
        /// </summary>
        ...
        public MfksAddToTransferRequest(string uyeEftKodu = default(string), string bordroNo = default(string), string kullaniciSicili = default(string), string belgeTipi = default(string), string islemTipiKodu = default(string), string belgeSeriNo = default(string), string belgeSiraNo = default(string), string belgeNoterYevmiyeNo = default(string), string saticiKimlikTip = default(string), string saticiKimlikNo = default(string), string saticiUnvan = default(string), string aliciKimlikTip = default(string), string aliciKimlikNo = default(string), string aliciUnvan = default(string), string belgeTarihi = default(string), double belgeTutari = default(double), string dovizKodu = default(string), double devirTutari = default(double), string kullandirimTipiKodu = default(string), string sektorKodu = default(string), string malHizmetCinsi = default(string), string muhasebeTarihi = default(string), string bankaIslemTipi = default(string), string aliciNeviKimlikTip = default(string), string aliciNeviKimlikNo = default(string), string saticiNeviKimlikTip = default(string), string saticiNeviKimlikNo = default(string), string belgeVadeTarihi = default(string), string bildirimDurumKodu = default(string), string teyitDurumKodu = default(string), string garantiDurumuKodu = default(string), string kasaNo = default(string), string tahsilatTipi = default(string), string istisnaMi = default(string), ProformaFaturaBean proformaFaturaInputBean = default(ProformaFaturaBean), SiparisFormuBean siparisFormuInputBean = default(SiparisFormuBean), SatisSozlesmesiBean satisSozlesmesiInputBean = default(SatisSozlesmesiBean), DevirEkleFaturaEkGirdiParametre faturaInputBean = default(DevirEkleFaturaEkGirdiParametre), AkreditifBean akreditifInputBean = default(AkreditifBean))
        {
            // to ensure "kullaniciSicili" is required (not null)
            if (kullaniciSicili == null)
            {
                throw new ArgumentNullException("kullaniciSicili is a required property for MfksAddToTransferRequest and cannot be null");
            }
        ...
        public DevirEkleFaturaEkGirdiParametre FaturaInputBean { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfksAddToTransferRequest {\n");
